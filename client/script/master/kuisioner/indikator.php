<script type="text/javascript">
  $(function() {
    var mode = 'ADD';
    var selectedUID = '';
    var DT = $("#table-indikator").DataTable({
      processing: true,
      serverSide: true,
      ...
      "ajax": {
        ...
        type: "POST",
        data: function(d) {
          d.request = "get_indikator_back_end";
        },
        headers: {
      ...
      "columns": [{
        ...
        render: function(data, type, row, meta) {
          return "<div class=\"btn-group wrap_content\" role=\"group\" aria-label=\"Basic example\">" +
            "<button class=\"btn btn-info btn-sm btn-edit-indikator\" id=\"indikator_edit_" + row.uid + "\">" +
            "<span><i class=\"fa fa-pencil-alt\"></i> Edit</span>" +
            "</button>" +
            "<button id=\"indikator_delete_" + row.uid + "\" class=\"btn btn-danger btn-sm btn-delete-indikator\">" +
    ...
    $("body").on("click", ".btn-edit-indikator", function() {
      ...
      $.ajax({
        async: false,
        url: __HOSTAPI__ + "/Kuisioner/indikator_detail/" + uid,
    ...
    $("body").on("click", ".btn-delete-indikator", function() {
      var uid = $(this).attr("id").split("_");
      uid = uid[uid.length - 1];
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              ...
              data: {
                uid: selectedUID,
                request: (mode === 'ADD') ? 'tambah_indikator' : 'edit_indikator',
                // domain: domain,
                nama: nama
              },
              type: "POST",
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal-large-title">Tambah Indikator</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group col-md-12">
          <label for="txt_no_skp">Nama Indikator :</label>
